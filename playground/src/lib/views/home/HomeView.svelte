			...
			<div transition:fly={{ delay: 100, y: 50, duration: 600 }}>
				<Card border="primary" class="h-100">
					...
					<CardBody>
						...
						<CodeSnippet language={xml} code={pathRoutingExample} title="Path Routing Example" />
						<div class="text-center mt-3">
							<Link href="/path-routing" class="btn btn-primary">Try Path Routing →</Link>
						</div>
					</CardBody>
				</Card>
			</div>
		...
		<div class="col-lg-4">
			<div transition:fly={{ delay: 200, y: 50, duration: 600 }}>
				<Card border="success" class="h-100">
					...
					<CardBody>
						<p class="card-text">
							Fragment-based routing that works everywhere! Perfect for modals, overlays, and
							client-side navigation. Also works great in Electron apps!
						</p>
						<p class="small text-muted mb-3">
							💡 <strong>Pro tip:</strong> Set <code>implicitMode: 'hash'</code> during
							initialization to avoid repeating <code>hash</code> on every component!
						</p>
						<CodeSnippet language={xml} code={hashRoutingExample} title="Hash Routing Example" />
						<div class="text-center mt-3">
							<Link href="/hash-routing" class="btn btn-success">Try Hash Routing →</Link>
						</div>
					</CardBody>
				</Card>
			</div>
		...
		<div class="col-lg-4">
			<div transition:fly={{ delay: 300, y: 50, duration: 600 }}>
				<Card border="warning" class="h-100">
					...
					<CardBody>
						<p class="card-text">
							<strong>World's first!</strong> Multiple independent hash routers running simultaneously.
							Perfect for micro-frontends!
						</p>
						<CodeSnippet language={xml} code={multiHashExample} title="Multi-Hash Example" />
						<div class="text-center mt-3">
							<Link href="/hash-routing" class="btn btn-warning text-dark">See Multi-Hash →</Link>
						</div>
					</CardBody>
				</Card>
			</div>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<ul class="list-unstyled">
									<li>✅ Less than 1,500 lines of code</li>
								...
								<ul class="list-unstyled">
									...
									<li class="world-first">
										🥇 <strong>World's first</strong> simultaneous path + hash routing
									</li>
									<li class="world-first">
										🥇 <strong>World's first</strong> Disconnected pieces of UI
									</li>
	...
	<div class="row mt-5">
		<div class="col-lg-10 offset-lg-1">
			<div
				...
				transition:fly={{ delay: 700, y: 50, duration: 600 }}
			>
				...
				<div class="d-flex flex-wrap justify-content-center gap-3">
					<Link href="/path-routing" class="btn btn-primary btn-lg">🛣️ Path Routing Demo</Link>
					<Link href="/hash-routing" class="btn btn-success btn-lg">🚀 Hash Routing Demo</Link>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="col">
			<div transition:fly={{ delay: 800, y: 50, duration: 600 }}>
				<Card>
					...
					<CardBody>
						<p>
							The following trace shows the current router's state and will appear throughout the
							demo pages. It's a powerful debugging tool that shows exactly how routes are being
