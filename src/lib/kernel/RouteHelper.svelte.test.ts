...
describe("RouteHelper", () => {
    ...
    describe("parseRoutePattern", () => {
        ...
        describe("Explicit Props", () => {
            ...
            test.each([
                { pattern: "/:id", expectedRegex: "^\\/(?<id>[^/]+)$", description: "single parameter" },
                { pattern: "/user/:userId", expectedRegex: "^\\/user\\/(?<userId>[^/]+)$", description: "parameter in path" },
                { pattern: "/:category/:id", expectedRegex: "^\\/(?<category>[^/]+)\\/(?<id>[^/]+)$", description: "multiple parameters" },
                { pattern: "/api-:version", expectedRegex: "^\\/api-(?<version>[^/]+)$", description: "parameter with prefix" },
            ...
            test.each([
                { pattern: "/:id?", expectedRegex: "^\\/?(?:(?<id>[^/]+))?$", description: "optional parameter" },
                { pattern: "/user/:id?", expectedRegex: "^\\/user\\/?(?:(?<id>[^/]+))?$", description: "optional parameter with leading slash" },
                { pattern: "/:category/:id?", expectedRegex: "^\\/(?<category>[^/]+)\\/?(?:(?<id>[^/]+))?$", description: "required and optional parameters" },
            ...
            test.each([
                { pattern: "/files/*", expectedRegex: "^\\/files(?<rest>.*)$", description: "rest parameter" },
                { pattern: "/api/v1/*", expectedRegex: "^\\/api\\/v1(?<rest>.*)$", description: "rest parameter in nested path" },
        ...
        describe("Base Path Integration", () => {
            test.each([
                ...
                { basePath: "/api/v1", pattern: "/users/:id", expectedRegex: "^\\/api\\/v1\\/users\\/(?<id>[^/]+)$", description: "nested base path with parameters" },
